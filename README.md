...
do the following: 
- study the stellar contract tests (particularly the yield adapter registry) to understand how the tests are implemented, make sure you understand the following: 
  - how the fixture pattern is applied 
  - how test cases are structured
  - how events are tested
  - how to mock authorization 
  - anything else you think is important

- rewrite the tests for all contracts except contracts/cusd_token, and packages/yield_adapter, use the fixture pattern make sure to achieve 100% coverage in terms of test cases, also ensure your testing the events emitted.
