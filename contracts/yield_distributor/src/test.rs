...
use soroban_sdk::{
    testutils::{Address as _, Events, Ledger as _}, vec, Address, Env, IntoVal, Symbol
};
use pretty_assertions::assert_eq;

use crate::contract::{YieldDistributor, YieldDistributorClient, YieldDistributorArgs};

// Helper function to create a test environment
fn setup_test() -> (Env, YieldDistributorClient<'static>, Address, Address, Address) {
    let env = Env::default();
